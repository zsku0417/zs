        ...
        <div class="content">
            ...
            <div class="left-side">
                ...
                <div class="address details">
                    ...
                    <div class="text-two">Wilayah Persekutuan Kuala Lumpu</div>
                </div>
            ...
            <div class="right-side">
                ...
                <form onsubmit="submitForm()" action="https://formsubmit.co/elderlyhomesclub@gmail.com" method="POST">
                    <input type="hidden" name="_subject" value="New Email from Unregistered user">
                    <div class="input-box">
                    ...
                    <input type="hidden" name="_next" value="http://localhost/Web%20Development/Assignment/health_monitoring/Index.php">
                </form>
            </div>
